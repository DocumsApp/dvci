...
from dvci import commands, git_utils, versions
...
class TestDelete(TestBase):
    ...
    def _test_delete(self, expected_message=None,
                     ...
                     **kwargs):
        if not expected_message:
            expected_message = r'^Removed \S+( in .*)? with dvci \S+$'
    ...
    def test_prefix_delete_all(self):
        ...
        self.assertRegex(message,
                         r'^Removed everything in prefix with dvci \S+$')
...
class TestServe(unittest.TestCase):
    ...
    def test_serve(self):
        ...
        handler_name = 'dvci.server.GitBranchHTTPHandler'
